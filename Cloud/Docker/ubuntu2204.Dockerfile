#       check -> https://hub.docker.com/r/nvidia/cuda/tags?page=1&name=ubuntu22
FROM nvcr.io/nvidia/cuda:12.4.1-cudnn-devel-ubuntu22.04

ARG TENSORRT_VERSION=10.1.0
ARG CUDA_USER_VERSION=12.4
ARG CUDNN_USER_VERSION=8.9.7
...
#      check -> https://docs.nvidia.com/deeplearning/tensorrt/support-matrix/index.html
